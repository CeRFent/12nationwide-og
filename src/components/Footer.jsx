      ...
      <footer className="bg-[#0d0e12] px-6 md:px-[60px] py-[70px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr] gap-10 border-t border-brand-accent/12">
        ...
        <div className="text-left">
          ...
          <div className="flex gap-2.5 mt-[18px]">
            {[
              { id: 'fb', url: 'https://www.facebook.com/profile.php?id=61566018981481' },
              { id: 'ig', url: 'https://www.instagram.com/12nationwidellc/' },
              { id: 'tt', url: 'https://www.tiktok.com/@couriernation?is_from_webapp=1&sender_device=pc' }
            ].map((social) => (
              <a 
                key={social.id} 
                href={social.url} 
                ...
                className="w-9 h-9 border border-white/12 rounded-full flex items-center justify-center transition-all hover:border-brand-cyan hover:bg-brand-cyan/10 group"
              >
