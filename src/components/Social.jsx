export default function Social() {
  return (
    <section id="social" className="bg-brand-bg px-6 md:px-[60px] py-[100px] text-center">
      <div className="font-display font-bold text-[12px] tracking-[3px] uppercase text-brand-cyan mb-3.5">
        Follow Us
      </div>
      <h2 className="font-display font-black text-[clamp(32px,5vw,62px)] uppercase text-brand-white mb-3.5 leading-none">
        See Us In Action
      </h2>
      <p className="text-[15px] text-white/50 mb-[50px]">
        Follow along on social for behind-the-scenes content, deliveries, and client highlights.
      </p>
      ...
      <div className="flex flex-wrap items-center justify-center gap-4">
        <a 
          href="https://www.facebook.com/profile.php?id=61566018981481" 
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2.5 font-display font-bold text-[14px] tracking-[1px] uppercase text-brand-white no-underline border border-white/20 px-7 py-3.5 rounded-[2px] transition-all hover:border-brand-cyan hover:bg-brand-cyan/5 hover:text-brand-cyan group"
        >
          <svg className="w-[18px] h-[18px] fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          Facebook
        </a>
        <a 
          href="https://www.instagram.com/12nationwidellc/" 
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2.5 font-display font-bold text-[14px] tracking-[1px] uppercase text-brand-white no-underline border border-white/20 px-7 py-3.5 rounded-[2px] transition-all hover:border-brand-cyan hover:bg-brand-cyan/5 hover:text-brand-cyan group"
        >
        ...
        <a 
          href="https://www.tiktok.com/@couriernation?is_from_webapp=1&sender_device=pc" 
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2.5 font-display font-bold text-[14px] tracking-[1px] uppercase text-brand-white no-underline border border-white/20 px-7 py-3.5 rounded-[2px] transition-all hover:border-brand-cyan hover:bg-brand-cyan/5 hover:text-brand-cyan group"
        >
